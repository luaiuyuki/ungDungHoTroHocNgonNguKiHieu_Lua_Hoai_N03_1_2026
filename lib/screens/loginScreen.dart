...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    final error = await _firebase.login(_userCtrl.text.trim(), _passCtrl.text);
    if (!mounted) return;
    setState(() => _isLoading = false);
    if (error != null) {
      setState(() => _errorMsg = error);
    }
    // Nếu đăng nhập thành công, StreamBuilder trong main.dart tự chuyển sang MainShell
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Sign In', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: textColor, letterSpacing: -0.5)),
              const SizedBox(height: 6),
              Text('Sign in to continue practicing', style: TextStyle(fontSize: 14, color: subColor)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: _inputDeco('Enter username', Icons.person_outline, primary, isDark),
                        validator: (v) {
                      ...
                      TextFormField(
                        ...
                        style: TextStyle(fontSize: 15, color: textColor),
                        decoration: _inputDeco('Enter password', Icons.lock_outline_rounded, primary, isDark,
                          suffix: IconButton(
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text('Sign Up', style: TextStyle(color: primary, fontSize: 14, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ],
